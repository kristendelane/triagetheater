...
const storyData: Record<string, GameScene> = {
  start: {
    ...
    text: [
      ...
      "Rather than sympathy and help, fighting the urge not to throw up in the middle of meetings (and often failing) earned you the label of 'unreliable employee'. It's not long before your b*tch of a boss (Yes, Michelle, I'm referring to you) puts you on an extensive PIP for <gasp!> fighting a serious and life-threatening chronic illness.",
...
uber_ride:{
  ...
  partner_drive: {
    ...
    resources: [
      {
        title: "Caring for a Partner with Chronic Illness",
        url: "https://www.healthline.com/health/chronic-illness/caring-for-partner"
      },
      {
        title: "When Both Partners Have Chronic Illness",
        url: "https://psychcentral.com/lib/sick-together-coping-when-both-partners-have-chronic-illness"
      },
      {
        title: "Emergency Room Preparation Checklist",
        items: [
          "List of current medications and dosages",
          "Insurance cards and ID",
          "List of allergies and previous reactions",
          "Recent medical history summary",
          "Comfort items (heating pad, water bottle, etc.)"
        ]
      }
    ],
    navigation: [
